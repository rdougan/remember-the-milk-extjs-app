...
If you are using the base app, you'll need to change the references from the default 'MyApp' namespace to your own namespace in the following files:
...
To enable the use of the build tools and generators below, you should also change the namespace config option in config/settings.yml to the namespace 
you use for your app.  There will be a script to do this all automatically shortly.
